...
const totalScore = `<h1> You got ${correct} out of 5 </h1>
                   <h2> Crown earned:</h2>`;
...
*/
if ( correct === 5 ) {
  alert("AND HE TAKES THE GOLD FOLKS!!! TOP SCORE!");
} else  if ( correct === 4 || correct === 3 ) {
  alert("AND HE TAKES THE SILVER FOLKS!!!");
} else if ( correct === 1 || correct === 2 ) {
  alert("Uwww, so sorry.. You're goin home with the Bronze today.");
} else {
  alert("You SUCK! You got a big fat ZERO! Re-watch and try again!");
}
